...
Production Vercel proof (`https://repligrant.vercel.app`):
...
The production browser loaded both canonical views through the same-origin `/genlayer-rpc` rewrite. After waiting for reads to settle, the console error/warning list was empty (`[]`).
